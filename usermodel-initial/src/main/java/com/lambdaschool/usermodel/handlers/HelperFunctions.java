...
public class HelperFunctions
{
    ...
    {
        Authentication authentication = SecurityContextHolder.getContext().getAuthentication(); //authentication class
        //inside SecurityContextHolder is the current authenticated user
