        ...
        extends AuthorizationServerConfigurerAdapter
{
    ...
    //static final String CLIENT_ID = "lambda-client"; -- used this if env variable was not there
    ...
    //static final String CLIENT_SECRET = "lambda-secret";--used this if env variable was not there
    /**
